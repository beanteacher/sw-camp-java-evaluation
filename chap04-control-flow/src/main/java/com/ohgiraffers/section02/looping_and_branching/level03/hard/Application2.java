...
public class Application2 {
    public static void main(String[] args) {
        ...
        while(randomNum != inputNum) {
            ...
            if(randomNum > inputNum) System.out.println("난수가 입력하신 정수보다 큽니다.");
            else if(randomNum < inputNum) System.out.println("난수가 입력하신 정수보다 작습니다.");
            else System.out.println("정답입니다. " + tryCount + "회 만에 정답을 맞추셨습니다.");
            tryCount++;
        }
    }
}
