...
public class Application1 {
    public static void main(String[] args) {
        ...
        StringBuilder changeInput = new StringBuilder();
        ...
        for(int i = 0; i < input.length(); i++) {
            if(input.charAt(i) == ' ') changeInput.append(input.charAt(i));
            else {
                char ch = (char) (input.charAt(i) + inputNum);
                changeInput.append(ch);
            }
        }
